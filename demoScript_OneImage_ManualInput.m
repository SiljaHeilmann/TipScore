...
ff = 4;%% Run with manual input for just one image file in folder (raw_images_lsm_files) with 8 test images
...
setDragConstraintFcn(h,fcn);
disp('')
prompt_nuc = 'What is the average diameter of nuclei in pixels? (~20 for test images) Enter integer number here and press enter) : ';
...
% the tails that have very low or very high tip scores contain few
